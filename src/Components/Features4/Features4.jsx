...
const Features4 = () => {
  return (
    <div class="grid md:grid-cols-3 max-w-screen-lg mx-auto gap-10 mt-16 px-5 bg-white pt-10 pb-10 mb-10">
      <div class="flex gap-4 items-start flex-col ">
        ...
        <div>
          ...
          <p class="mt-1 text-gray-500">
            {" "}
            You don't need to be an expert to use our plugin. Our expressive API
      ...
      <div class="flex gap-4 items-start flex-col ">
        ...
        <div>
          ...
          <p class="mt-1 text-gray-500">
            {" "}
            Our plugins do not have any external dependencies so our plugin has
            the minimal footprint possible.
          </p>
        </div>
      </div>
    </div>
